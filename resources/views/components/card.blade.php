<div class="rounded-lg border border-gray-200 bg-white shadow">
    ...
    <div class="p-5">
        ...
        <div class="flex flex-col items-start gap-x-2 gap-y-2 xl:flex-row">
            <a href="{{ route('candidates.detail', $id) }}" class="inline-flex items-center rounded-lg bg-white px-3 py-2 text-center text-sm font-medium text-blue-700 ring-1 ring-blue-700 transition-colors duration-200 hover:bg-blue-700 hover:text-white">
                Lihat Visi & Misi
