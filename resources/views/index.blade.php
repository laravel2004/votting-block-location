...
@section('content')
    ...
    <section class="flex w-full flex-col items-center justify-center">
        ...
        <div class="flex w-full flex-col items-end justify-center gap-3 sm:w-1/2 sm:flex-row xl:w-1/3">
    ...
    <section>
        ...
        <div class="mt-24 flex items-center justify-center bg-white px-5 py-5" x-data="beer()" x-init="start()">
            <div class="text-black">
                <h1 class="mb-3 text-center text-3xl font-extralight">Waktu hitung mundur hingga pemilu 2024</h1>
                <div class="flex w-full items-center justify-center text-center text-6xl">
                    <div class="mr-1 text-2xl font-extralight">Dalam</div>
